        ...
        <div class="col-sm-12">
            <table class="data-table table stripe hover nowrap dataTable no-footer dtr-inline ">
                ...
                @if ($noPendingJobForTechnician)
                    <tr>
                        <td colspan="6" style="text-align: center; font-size: 1.125rem;">There is no jobs for you !</td>
                    </tr>
                @else
                @php
                    $counter = 0;
                ...
                @foreach ($viewPendingJobForTechnician as $value)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('technician/job/view_more_job_description/'. $value->job_id) }}" class="btn btn-sm btn-primary" style="font-size: 1.5rem;">View Job Description</a>
