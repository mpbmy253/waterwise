...
<div class="min-height-200px">
    <div class="mt-1 mb-5">
        <div class="mb-5">
            <h4>Create New System Admin Account For Seller</h4>
        </div>
    </div>
    ...
    <div class="pd-20 card-box mb-30" style="overflow-y: auto;">
        <form method="post" action="">
            ...
            <div class="form-group">
                <label style="font-size: 1.5rem;" style="font-size: 1.5rem;">Seller Company <span style="color:red;">*</span></label>
                <select class="form-control company_listing" required name="company" style="font-size: 1.5rem;">
                    <option style="font-size: 1.5rem;" value="">Select Seller Company</option>
                    @foreach ($sysAdminNotYetCreatedSeller as $value)
                        <option style="font-size: 1.5rem;" value="{{ $value->company_id }}">{{ $value->company_name }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                <label style="font-size: 1.5rem;" style="font-size: 1.5rem;">First Name <span style="color:red;">*</span></label>
            ...
            <div class="form-group">
                <label style="font-size: 1.5rem;" style="font-size: 1.5rem;">Last Name <span style="color:red;">*</span></label>
            ...
            <div class="form-group">
                <label style="font-size: 1.5rem;" style="font-size: 1.5rem;">Username <span style="color:red;">*</span></label>
            ...
            <div class="form-group">
                <label style="font-size: 1.5rem;" style="font-size: 1.5rem;">Email Address <span style="color:red;">*</span></label>
            ...
            <div class="form-group">
                <label style="font-size: 1.5rem;" style="font-size: 1.5rem;">Mobile Number <span style="color:red;">*</span></label>
            ...
            <div class="form-group">
                <label style="font-size: 1.5rem;" style="font-size: 1.5rem;">Gender <span style="color:red;">*</span></label>
            ...
            <div class="form-group">
                <label style="font-size: 1.5rem;" style="font-size: 1.5rem;">Password <span style="color:red;">*</span></label>
...
<script>
    $(document).ready(function() {
        $(document).on('change', '.company_listing', function() {
            ...
            $.ajax({
                type: 'GET',
                url: '{!! URL::to('autoFillUserDetailsBasedOnSellerSelection') !!}',
                data: {'id': company_id},
