...
<head>
    ...
    <link rel="stylesheet" href="{{ url('marketing_website/styles/FullPackage.css') }}" />
...
<body>
	<div class="full-package-page">
		<div class="top">
			<svg class="gradient-bg" width="2240" height="300" viewBox="0 0 2240 300" fill="none"
				...
				<path d="M0 0H1088.07H2240V280.087C1034.33 126.443 905.357 375.007 0 275.885V0Z"
					fill="url(#paint0_linear_81_354)" />
				<defs>
					<linearGradient id="paint0_linear_81_354" x1="1085.54" y1="-3.30172" x2="1085.54" y2="616.493"
		...
		<div class="full-package">Full package</div>
				...
				<button class="rectangle-background">
                    <a href="{{url('/register')}}">
                        <div class="package-content3">
                            ...
                            <div class="include-mobile-app">Include mobile app</div>
                        </div>
                        <div class="line-113"></div>
                        <div class="pricing3">
                            <div class="_178">$178</div>
				...
				<button class="rectangle-background2">
                    <a href="{{url('/register')}}">
                        <div class="package-content2">
                            ...
                            <div class="include-mobile-app2">Include mobile app</div>
                        </div>
                        <div class="line-112"></div>
                        <div class="pricing2">
                            <div class="save-10">save 10%</div>
                            <div class="_961">$961</div>
